...
class ApiService {
  ...
  final String readKey =
      "SX3NIM36S998X9H4"; // SESUAIKAN DENGAN READ API KEYS PADA AKUN MASING-MASING

  String field1Url =
      "https://api.thingspeak.com/channels/3089718/fields/1/last.json?api_key="; // SESUAIKAN DENGAN CHANNEL ID PADA AKUN MASING-MASING
  String field2Url =
      "https://api.thingspeak.com/channels/3089718/fields/2/last.json?api_key="; // SESUAIKAN DENGAN CHANNEL ID PADA AKUN MASING-MASING
  String field3Url =
      "https://api.thingspeak.com/channels/3089718/fields/3/last.json?api_key="; // SESUAIKAN DENGAN CHANNEL ID PADA AKUN MASING-MASING
